...
if %FUNCTION_MODE% == "com.wangjiafu.swagger.config" (
    set "NACOS_OPTS=%NACOS_OPTS% -Dnacos.functionMode=com.wangjiafu.swagger.config"
)
...
rem set nacos spring com.wangjiafu.swagger.config location
set "NACOS_CONFIG_OPTS=--spring.com.wangjiafu.swagger.config.additional-location=%CUSTOM_SEARCH_LOCATIONS%"

rem set nacos log4j file location
set "NACOS_LOG4J_OPTS=--logging.com.wangjiafu.swagger.config=%BASE_DIR%/conf/nacos-logback.xml"
